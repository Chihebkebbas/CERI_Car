        ...
        <section class="results-section">
            ...
            <div class="results-scroll-container">
                ...
                <?php foreach ($voyages as $voyage): ?>
                    ...
                    <article class="trip-card" onclick="toggleCard(this)">
                    <div class="trip-main">
                        <div class="trip-overview">
                            ...
                            <div class="trip-meta-visible">
                                ...
                                <div class="price-block">
                                    ...
                                    <span class="seats-left"><?=$voyage->nombrePlacesDispo - $places ?> <?=$voyage->nombrePlacesDispo - $places == 1 ? "place" : "places" ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="expanded-content">
                            ...
                            <div class="detail-column">
                                ...
                                <div class="badges-list">
                                    ...
                                    <span class="badge"><span class="material-symbols-rounded">notification_audio</span><?=$voyage->contraintes ?></span>
                                </div>
                            </div>
...
<script>
    function toggleCard(card) {
        if (card.classList.contains('full-trip')) return;
