    ...
    <section class="auth-card wide">
        ...
        <input type="hidden" name="<?= Yii::$app->request->csrfParam; ?>" value="<?= Yii::$app->request->csrfToken; ?>" />
            ...
            <div class="form-group">
                ...
                <input type="text" id="pseudo" name="pseudo" class="form-input" placeholder="Choisissez un pseudo" required>
            </div>
            ...
            <div class="form-group full-width">
                ...
                <input type="password" id="password" name="password" class="form-input" placeholder="8 caractères minimum" required minlength="8">
            </div>

            <div class="form-group">
                <label for="permis" class="form-label">N° Permis <span>(Optionnel)</span></label>
                <input type="text" id="permis" name="permis" class="form-input" placeholder="Pour les conducteurs">
            </div>

            <div class="form-group">
                <label for="photo" class="form-label">Photo URL <span>(Optionnel)</span></label>
                <input type="url" id="photo" name="photo" class="form-input" placeholder="https://...">
            </div>
